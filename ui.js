// in this file we are managing all our frontend changes

import * as constants from "./constants.js";
import * as elements from "./elements.js";
// below w'll be receiving the personal code
...
//here w'll receive the stream by getUserMedia and then we can open the video mannually 
...
export const showInfoDialog = (preOfferAnswer) => {
  ...
  if (preOfferAnswer === constants.preOfferAnswer.CALLEE_NOT_FOUND) {
    infoDialog = elements.getInfoDialog(
      "Callee not found",
      "Please enter the correct meeting ID"
    );
  }
