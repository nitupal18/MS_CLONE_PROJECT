...
// here we initialize socketIO connection which is receiving the socket
const socket = io("/");
wss.registerSocketEvents(socket);

webRTCHandler.getLocalPreview();

//here we register event listener for personal code copy button
...
// here we register event listeners for connection buttons
...
// after getting the code ,constants will let us choose the call type
...
// gere we register event for allow connections from strangers
