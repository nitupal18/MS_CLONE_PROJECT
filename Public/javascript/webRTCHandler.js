//here w'll write the connection logic using webrtc
...
//getUserMedia ia webrtc api, which will ask fro access to audio and video
//we use it here as a promise , then w'll receive a stream which will will help to update ui
// and create a function setLocalStream which keeps reference of it
...
// RTCPeerConnection will pass the audio and video stream
const createPeerConnection = () => {
  ...
  // add our stream to peer connection if the connected personal code it same provide by the stun server
...
export const handlePreOfferAnswer = (data) => {
  ...
  if (preOfferAnswer === constants.preOfferAnswer.CALL_ACCEPTED) {
    ...
    createPeerConnection();
    sendWebRTCOffer();
    //here the webrtc offer is being send
  }
};
